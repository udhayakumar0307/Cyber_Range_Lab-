...
def seed_labs_and_modules(session):
    ...
    labs_data = [
        ...
        {
            "id": "puzzle-lab",
            "name": "Puzzle — System Hardening & Sysadmin Security Lab",
            "category": "puzzle",
            "difficulty": "Advanced",
            "max_points": 2400,
            "estimated_time": 240,
            ...
            "modules": [
                ...
                ("puzzle-lab_module11", 11, "Level 10 -> Level 11: sudo Basics & sudoers Security (Capstone)", "Configure NOPASSWD sudo rules with visudo.", 350, "puzzle"),
            ],
        },
    ]
