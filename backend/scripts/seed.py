...
def seed_achievements(session):
    ...
    achievements = [
        ...
        ("500-points", "500 Points Milestone", "Reached a total of 500 learning points!", "award", "points_500", 500),
        ("1000-points", "1000 Points Milestone", "Reached a total of 1000 learning points!", "trophy", "points_1000", 1000),
